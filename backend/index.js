...
// all up the first endpoint is in data.js in the Model now, but could also be here following Skinny Model, fat Controller
...
app.get("/notifications", (req, res) => {
	...
	// put all the "Model" into data.js, which is Fat Model, Skinny Controller now
	getAllNotifications(req, res);

	// this is Skinny (No) Model, Fat Controller
